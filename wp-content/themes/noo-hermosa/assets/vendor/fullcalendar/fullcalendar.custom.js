...
TimeGrid.mixin({
	...
	fgSegHtml: function(seg, disableResizing) {
		...
		trainerHtml = '<div class="fc-trainer">' + this.view.options.textWith + ' ' + htmlEscape(event.trainer) + '</div>';
			...
			'>' +
				'<div class="fc-content">' +
					...
					(timeText ?
						...
						(event.categoryName ?
						'<div class="fc-category" style="background-color:' + event.categoryColor + '">' +
...
var AgendaView = View.extend({
	...
	headIntroHtml: function() {
		...
		if (this.opt('weekNumbers')) {
			...
			return '<th class="fc-axis ' + this.widgetHeaderClass + '" ' + this.axisStyleAttr() + '>' + this.options.labelColumnTime + '</th>';
		}
	},
