...
?>
<div class="navbar navbar-header5 noo-container">
    ...
    <div class="menu-position">
        ...
        <nav class="noo-main-menu noo-left-menu <?php echo esc_attr( $wp_nav_menu_counter >= 8 ) ? 'menu-less' : ''; ?>">
            <?php
            wp_nav_menu( array(
                'theme_location' => 'primary-menu',
                'container'      => false,
    ...
    <?php endif; ?>
     ...
     <?php if ($use_cart) : ?>
        <div
            class="noo-top-right-widget <?php echo esc_attr($class_cart_hide_fix); ?>">
            <a href="<?php echo wc_get_cart_url()?>  " title="View Cart" class="mobile-minicart-icon" >
