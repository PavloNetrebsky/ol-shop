...
if ( ! class_exists( 'Noo_Hermosa_Check_Version' ) ) {

    class Noo_Hermosa_Check_Version {
         ...
         * settings fields so that Noo_Hermosa_Check_Version can still find the settings values.
         */
        public function add_license_settings_page() {
            $title = sprintf( esc_html__( '%s License', 'noo-hermosa' ), $this->product_name );
        ...
        public function add_license_settings_fields() {
            ...
            add_settings_section(
                $settings_section_id,
                sprintf( noo_hermosa_kses( __( 'License <a target="_blank" href="%s" style="">How to get License key?</a>', 'noo-hermosa' ) ), 'http://support.nootheme.com/wp-content/uploads/2015/07/HowToGetPurchaseCode.png' ),
            ...
            add_settings_field(
                ...
                esc_html__( 'License e-mail or domain address', 'noo-hermosa' ),
            ...
            add_settings_field(
                ...
                esc_html__( 'License key', 'noo-hermosa' ),
        ...
        public function show_admin_notices() {
            ...
            if ( ! $options || ! isset( $options['email'] ) || ! isset( $options['license_key'] ) ||
                ...
                $msg = esc_html__( 'Please enter your license key to enable updates to %s.', 'noo-hermosa' );
                $msg = sprintf( $msg, $this->product_name );
                ?>
                <div class="update-nag">
                    <p>
                        <?php echo noo_hermosa_kses( $msg ); ?>
                    </p>

                    <p>
                        <a href="<?php echo admin_url( 'options-general.php?page=' . $this->get_settings_page_slug() ); ?>">
                            <?php echo esc_html__( 'Complete the setup now.', 'noo-hermosa' ); ?>
                        </a>
                    </p>
                </div>
            <?php
