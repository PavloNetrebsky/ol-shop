...
<div id="noo-shortcodes-form-wrapper">
  <form id="noo-shortcodes-form" name="noo-shortcodes-form" method="post" action="">
    <div class="noo-form-body">
      ...
      <div class="noo-form-group">
        ...
        <div class="noo-control">
          <select name="orderby" id="orderby">
            ...
            <option value='next_date'><?php _e('Current Date', 'noo-timetable'); ?></option>
            <option value='start_date'><?php _e('Start Date', 'noo-timetable'); ?></option>
            <option value='latest'><?php _e('Recent Post Date First', 'noo-timetable'); ?></option>
            <option value='oldest'><?php _e('Older Post Date First', 'noo-timetable'); ?></option>
      ...
      <div class="noo-form-group">
        <label for="hide_past_event"><?php _e('Hide Past Event', 'noo-timetable'); ?></label>
        <div class="noo-control">
          <input id="hide_past_event" type="checkbox" name="hide_past_event" />
        </div>
      </div>
      <hr>
      <div class="noo-form-group">
