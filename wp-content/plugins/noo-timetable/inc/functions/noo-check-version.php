<?php
/**
 * Check current version of plugin on server
 *
 * @author      NooTheme
 * @category    API
...
if ( ! class_exists( 'Noo_Timetable_Check_Version' ) ) {

    class Noo_Timetable_Check_Version {
         ...
         * settings fields so that Noo_Timetable_Check_Version can still find the settings values.
         */
        public function add_license_settings_page() {
            $title = sprintf( esc_html__( '%s License', 'noo-timetable' ), $this->product_name );
        ...
        public function add_license_settings_fields() {
            ...
            add_settings_section(
                $settings_section_id,
                sprintf( noo_timetable_kses( __( 'License <a target="_blank" href="%s" style="">How to get License key?</a>', 'noo-timetable' ) ), 'http://support.nootheme.com/wp-content/uploads/2015/07/HowToGetPurchaseCode.png' ),
            ...
            add_settings_field(
                ...
                esc_html__( 'License e-mail or domain address', 'noo-timetable' ),
            ...
            add_settings_field(
                ...
                esc_html__( 'License key', 'noo-timetable' ),
        ...
        public function show_admin_notices() {
            ...
            if ( ! $options || ! isset( $options['email'] ) || ! isset( $options['license_key'] ) ||
                ...
                $msg = esc_html__( 'Please enter your license key to enable updates to %s.', 'noo-timetable' );
                ...
                <div class="update-nag">
                    ...
                    <p>
                        <a href="<?php echo admin_url( 'options-general.php?page=' . $this->get_settings_page_slug() ); ?>">
                            <?php echo esc_html__( 'Complete the setup now.', 'noo-timetable' ); ?>
                        </a>
                    </p>
                </div>
            <?php
        ...
        public function get_license_info() {
            ...
            if ( ! isset( $options['email_license'] ) || ! isset( $options['license_key'] ) ) {
