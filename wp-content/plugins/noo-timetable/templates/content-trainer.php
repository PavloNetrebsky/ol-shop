...
<article <?php post_class($post_class . ' trainer-tag-wrap'); ?>>
	<div class="trainer-bio">
        ...
        <div class="trainer-info">
            <h4>
                <a title="<?php printf( esc_html__( 'Post by %s','noo-timetable'), get_the_title(get_the_ID()) ); ?>" href="<?php echo get_permalink(get_the_ID()) ; ?>" rel="author">
            ...
            <div class="trainer-excerpt">
                ...
                $exc_length = NOO_Settings()->get_option('noo_trainer_excerpt_length', 28);
                echo '<p>' . wp_trim_words($excerpt, $exc_length, '...') . '</p>';
                ?>
            </div>

            <a class="button view-profile" title="<?php printf( esc_html__( 'Post by %s','noo-timetable'), get_the_title(get_the_ID()) ); ?>" href="<?php echo get_permalink(get_the_ID()); ?>" rel="author">
