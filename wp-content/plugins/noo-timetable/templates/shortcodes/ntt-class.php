...
if ( ! function_exists( 'shortcode_ntt_class' ) ) :
	...
	function shortcode_ntt_class( $atts ) {
        ...
        $args = apply_filters( 'noo_timetable_ntt_class_query_args', $args );
            ...
            if ( $query->have_posts() ) :
                ...
                <div class="noo-class-wrap">
                    ...
                    ?>      
                        ...
                        <?php endif;?>
                    <?php endif;?>
                    <!-- <div class="<?php echo ( $layout_style == 'grid' || $layout_style == 'list' ) ? $layout_style : 'grid'; ?>"> -->
                    ...
                    <!-- </div> -->
                    <?php //noo_timetable_get_template( 'class/sidebar.php' );?>
                </div>
                <?php if ( $layout_style == 'slider' ) :  ?>
