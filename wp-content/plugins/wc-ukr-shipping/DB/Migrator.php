...
use kirillbdev\WCUkrShipping\DB\Migrations\Migration;
...
class Migrator
{
    ...
    public function __construct()
    {
        ...
        $history = get_option(WCUS_MIGRATOR_HISTORY_KEY);
    ...
    public function run()
    {
        ...
        if ($this->works) {
            update_option(WCUS_MIGRATOR_HISTORY_KEY, json_encode($this->history));
        }
    }
}