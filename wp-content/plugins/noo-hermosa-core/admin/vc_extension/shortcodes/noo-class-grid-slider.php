...
if ( ! function_exists( 'shortcode_noo_class_grid_slider' ) ) :
	
	function shortcode_noo_class_grid_slider( $atts ) {
            ...
            ?>
                        ...
                        <div class="masonry-container">
                            ...
                            <article <?php post_class($post_class); ?>>
                                <div class="loop-item-wrap">
                                    ...
                                    <?php
                                        $feat_image_url = wp_get_attachment_image_src( get_post_thumbnail_id(), array(800, 600) );
                                    ?>
                                    ...
                                    <div class="loop-item-content">
                                        <div class="loop-item-content-summary">
                                            ...
                                            <h2 class="loop-item-title">
                                                <a href="<?php the_permalink(); ?>" title="<?php echo esc_attr( sprintf( wp_kses( __( 'Permanent link to: "%s"','noo-hermosa-core' ), noo_hermosa_allowed_html() ), the_title_attribute( 'echo=0' ) ) ); ?>"><?php the_title(); ?></a>
                                            </h2>
                                            <div class="content-meta">
                                                ...
                                                <?php
                                                    ...
                                                    $class_dates = array(
                                                        'open_date'       => $open_date,
                                                        'number_of_weeks' => noo_hermosa_get_post_meta( get_the_ID(), "_number_of_weeks", '1'),
                                        ...
                                        <div class="loop-item-action">
                                            <a class="btn" href="<?php the_permalink()?>"><?php echo esc_html__('Learn More','noo-hermosa-core')?></a>
                                        </div>
                                        ...
                                        <?php
                                            ...
                                            foreach ($trainer_ids as $k => $trid) :
                                                ...
                                                $trainer_image_url = wp_get_attachment_image_src( get_post_thumbnail_id($trid), 'noo-thumbnail-small' ); ?>
                ...
                <?php if ( $layout_style == 'slider' ) :  ?>
                    ...
                    jQuery(document).ready(function(){
                        ...
                        jQuery('.noo-class-slider-shortcode .masonry-container').each(function(){
	...
	add_shortcode( 'noo_class_grid_slider', 'shortcode_noo_class_grid_slider' );
